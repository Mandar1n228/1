...
<body>
  ...
  <script>
    ...
    // Calendar controls
    const calendarStorageKey = "gateway_controls_calendar_v1";
    ...
    let controlEvents = loadControlEvents();
    ...
    function persistControlEvents() {
      localStorage.setItem(calendarStorageKey, JSON.stringify(controlEvents));
    }
    ...
    const historyChartsGrid = document.getElementById("historyChartsGrid");
    let historyMode = "24h";
